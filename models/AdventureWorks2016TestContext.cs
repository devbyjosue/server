...
public partial class AdventureWorks2016TestContext : DbContext
{
    public AdventureWorks2016TestContext()
    {
    }

    public AdventureWorks2016TestContext(DbContextOptions<AdventureWorks2016TestContext> options)
        : base(options)
    {
    }
